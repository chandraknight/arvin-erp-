...
REPORT_REGISTRY = {
    ...
    'stock_valuation_report': {
        ...
        'url_name': 'reports:stock_valuation_report',
        'section': 'Inventory & Products',
    ...
    'debtors_creditors_report': {
        ...
        'description': 'Party-wise trade receivables and payables schedule (NFRS)',
        'url_name': 'reports:debtors_creditors_report',
        'section': 'Receivables & Payments',
    ...
    'cash_book_report': {
        ...
        'url_name': 'reports:cash_book_report',
        'section': 'Bookkeeping',
    ...
    'bank_book_report': {
        'label': 'Bank Book',
        'description': 'Chronological Dr/Cr ledger per bank account with running balance',
        'url_name': 'reports:bank_book_report',
        'section': 'Bookkeeping',
    ...
    'party_ledger_report': {
        'label': 'Party Ledger (Statement of Account)',
        'description': 'Running-balance transaction history for a single customer or vendor',
        'url_name': 'reports:party_ledger_report',
        'section': 'Bookkeeping',
        'icon': 'fas fa-file-invoice',
        'color': 'cyan',
        'module_flag': None,
    ...
    'general_ledger_report': {
        ...
        'description': 'Running-balance Dr/Cr statement for any ledger account',
        'url_name': 'reports:general_ledger_report',
        'section': 'Bookkeeping',
    ...
    'nfris_tax_report': {
        'label': 'NFRIS Tax Report',
        'description': 'Consolidated IRD e-billing tax summary — output/input VAT, TDS, estimated corporate tax',
        'url_name': 'reports:nfris_tax_report',
        'section': 'Tax & VAT',
        'icon': 'fas fa-file-invoice-dollar',
        'color': 'amber',
        'module_flag': None,
    },
    'tax_depreciation_schedule_report': {
        'label': 'Tax Depreciation Schedule (D1/D2/D3)',
        'description': 'Income Tax Act Schedule 2 pooled WDV depreciation by asset pool',
        'url_name': 'reports:tax_depreciation_schedule_report',
        'section': 'Tax & VAT',
    ...
    # ── Statutory / Compliance (always visible) ────────────────────────────
    'vat_sales_register': {
        'label': 'VAT Sales Register',
        'description': 'Transaction-level output tax register (IRD Bikri Khata)',
        'url_name': 'reports:vat_sales_register',
    ...
    'vat_purchase_register': {
        ...
        'description': 'Transaction-level input tax register (IRD Kharid Khata)',
        'url_name': 'reports:vat_purchase_register',
        'section': 'Statutory / Compliance',
        'icon': 'fas fa-file-invoice',
        'color': 'emerald',
        'module_flag': 'vat_registered',
    ...
    'balance_confirmation_report': {
        'label': 'Balance Confirmation',
        'description': 'Audit confirmation letters — party ledger balance snapshots as of a date',
        'url_name': 'reports:balance_confirmation_report',
        'section': 'Statutory / Compliance',
...
SECTION_ICONS = {
    ...
    'Statutory / Compliance': ('fas fa-gavel', 'rose'),
