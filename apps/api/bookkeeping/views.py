...
class JournalEntryListView(AuthMixin, ListView):
    ...
    def get_queryset(self):
        ...
        journal_type = self.request.GET.get('journal_type', '').strip()
        if journal_type:
    ...
    def get_context_data(self, **kwargs):
        ...
        from .models import JOURNAL_TYPE_CHOICES
        context['journal_type_choices'] = JOURNAL_TYPE_CHOICES
        context['selected_journal_type'] = self.request.GET.get('journal_type', '')
        return context
